...
public class FAMProtocol extends TWPProtocol {
	...
	public void sendChanged(Path  directory , String  filename ) throws IOException {
		...
		message.addParameter(decompose(directory));
		message.addParameter(decompose(filename));
	...
	public FAMChanged receiveChanged() throws IOException {
		...
		FAMChanged req = new FAMChanged(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
		return req;
	}
	...
	public FAMDeleted receiveDeleted() throws IOException {
		...
		Iterator<Parameter> iter = message.getParameters().iterator();
		FAMDeleted req = new FAMDeleted(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
		return req;
	}
	...
	public FAMCreated receiveCreated() throws IOException {
		...
		Iterator<Parameter> iter = message.getParameters().iterator();
		FAMCreated req = new FAMCreated(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
		return req;
	}
	...
	public FAMStartExecuting receiveStartExecuting() throws IOException {
		...
		Iterator<Parameter> iter = message.getParameters().iterator();
		FAMStartExecuting req = new FAMStartExecuting(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
		return req;
	}
	...
	public FAMStopExecuting receiveStopExecuting() throws IOException {
		...
		Iterator<Parameter> iter = message.getParameters().iterator();
		FAMStopExecuting req = new FAMStopExecuting(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
		return req;
	}
	...
	public void onMessage(Message message) throws IOException {
		...
		case 0:
				FAMChanged req0 = new FAMChanged(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
				handler.onFAMChanged(req0);
				break;
		case 1:
				FAMDeleted req1 = new FAMDeleted(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
				handler.onFAMDeleted(req1);
				break;
		case 2:
				FAMCreated req2 = new FAMCreated(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
				handler.onFAMCreated(req2);
				break;
		case 3:
				FAMStartExecuting req3 = new FAMStartExecuting(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
				handler.onFAMStartExecuting(req3);
				break;
		case 4:
				FAMStopExecuting req4 = new FAMStopExecuting(this, new Path((GenericSequence ) compose(iter.next())) , (String) iter.next().getValue() );
